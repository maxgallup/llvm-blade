...
entry:
  ...
  %add = add nsw i32 %0, %1
  store i32 %add, ptr %waist, align 4
  %2 = load i32, ptr %waist, align 4
  %add4 = add nsw i32 %2, 3
  store i32 %add4, ptr %x, align 4
  %3 = load i32, ptr %waist, align 4
  %add5 = add nsw i32 %3, 5
...
^3 = gv: (name: "__const.main.a", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 9899568590028124334
^4 = gv: (name: "main", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 44, funcFlags: (readNone: 0, readOnly: 0, noRecurse: 0, returnDoesNotAlias: 0, noInline: 1, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0), calls: ((callee: ^1, relbf: 256), (callee: ^5, relbf: 256), (callee: ^2, relbf: 512)), refs: (^3)))) ; guid = 15822663052811949562
