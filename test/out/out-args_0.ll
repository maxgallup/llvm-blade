...
entry:
  ...
  %argc.addr = alloca i32, align 4, !BLADE-S !8
  ...
  store i32 %argc, ptr %argc.addr, align 4, !BLADE-T !9
  store ptr %argv, ptr %argv.addr, align 8, !BLADE-T !9
