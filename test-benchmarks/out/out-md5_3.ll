...
entry:
  %conv = trunc i32 %val to i8, !BLADE-T !7
  store i8 %conv, ptr %bytes, align 1, !tbaa !8, !BLADE-T !7
  %shr = lshr i32 %val, 8, !BLADE-T !7
  %conv1 = trunc i32 %shr to i8
  %arrayidx2 = getelementptr inbounds i8, ptr %bytes, i64 1, !BLADE-T !7
  store i8 %conv1, ptr %arrayidx2, align 1, !tbaa !8
  %shr3 = lshr i32 %val, 16, !BLADE-T !7
  %conv4 = trunc i32 %shr3 to i8
  %arrayidx5 = getelementptr inbounds i8, ptr %bytes, i64 2, !BLADE-T !7
  store i8 %conv4, ptr %arrayidx5, align 1, !tbaa !8
  %shr6 = lshr i32 %val, 24, !BLADE-T !7
  %conv7 = trunc i32 %shr6 to i8
  %arrayidx8 = getelementptr inbounds i8, ptr %bytes, i64 3, !BLADE-T !7
  store i8 %conv7, ptr %arrayidx8, align 1, !tbaa !8
  ret void
}
...
entry:
  %0 = load i32, ptr %bytes, align 1, !BLADE-T !7
  ret i32 %0
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %w) #10, !BLADE-T !7
  %add = add i64 %initial_len, 1, !BLADE-T !7
  br label %for.cond

for.cond:                                         ; preds = %for.cond, %entry
  %indvars.iv248 = phi i64 [ %indvars.iv.next249, %for.cond ], [ %initial_len, %entry ], !BLADE-T !7
  ...
  br i1 %cmp.not, label %for.end, label %for.cond, !llvm.loop !11

for.end:                                          ; preds = %for.cond
  %add1 = add i64 %new_len.0, 8
  %call = tail call noalias ptr @malloc(i64 noundef %add1) #11, !BLADE-T !7
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %call, ptr align 1 %initial_msg, i64 %initial_len, i1 false), !BLADE-T !7
  %arrayidx = getelementptr inbounds i8, ptr %call, i64 %initial_len, !BLADE-T !7
  store i8 -128, ptr %arrayidx, align 1, !tbaa !8
...
for.cond17.preheader:                             ; preds = %for.end85, %for.cond17.preheader.preheader
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %w, ptr noundef nonnull align 1 dereferenceable(64) %uglygep239, i64 64, i1 false), !BLADE-T !7
  br label %for.body32

for.body32:                                       ; preds = %if.end61, %for.cond17.preheader
...
if.end61:                                         ; preds = %if.else54, %if.then49, %if.then38, %if.then
  ...
  %arrayidx64 = getelementptr inbounds [64 x i32], ptr @k, i64 0, i64 %indvars.iv, !BLADE-S !13
  %7 = load i32, ptr %arrayidx64, align 4, !tbaa !14, !BLADE-T !7
  %add65 = add i32 %add62, %7
  %arrayidx67 = getelementptr inbounds [16 x i32], ptr %w, i64 0, i64 %g.0, !BLADE-S !13
  %8 = load i32, ptr %arrayidx67, align 4, !tbaa !14, !BLADE-T !7
  %add68 = add i32 %add65, %8
  %arrayidx70 = getelementptr inbounds [64 x i32], ptr @r, i64 0, i64 %indvars.iv, !BLADE-S !13
  %9 = load i32, ptr %arrayidx70, align 4, !tbaa !14, !BLADE-T !7
  %shl = shl i32 %add68, %9
  %sub = sub i32 32, %9
  ...
  br i1 %exitcond.not, label %for.end85, label %for.body32, !llvm.loop !16
...
for.end85:                                        ; preds = %if.end61
  ...
  br i1 %exitcond250.not, label %for.end92, label %for.cond17.preheader, !llvm.loop !17

for.end92:                                        ; preds = %for.end85
  tail call void @free(ptr noundef %call) #10, !BLADE-T !7
  %conv.i177 = trunc i32 %add86 to i8
  store i8 %conv.i177, ptr %digest, align 1, !tbaa !8, !BLADE-T !7
  %shr.i178 = lshr i32 %add86, 8
  %conv1.i179 = trunc i32 %shr.i178 to i8
  %arrayidx2.i180 = getelementptr inbounds i8, ptr %digest, i64 1, !BLADE-T !7
  store i8 %conv1.i179, ptr %arrayidx2.i180, align 1, !tbaa !8
  %shr3.i181 = lshr i32 %add86, 16
  %conv4.i182 = trunc i32 %shr3.i181 to i8
  %arrayidx5.i183 = getelementptr inbounds i8, ptr %digest, i64 2, !BLADE-T !7
  store i8 %conv4.i182, ptr %arrayidx5.i183, align 1, !tbaa !8
  %shr6.i184 = lshr i32 %add86, 24
  %conv7.i185 = trunc i32 %shr6.i184 to i8
  %arrayidx8.i186 = getelementptr inbounds i8, ptr %digest, i64 3, !BLADE-T !7
  store i8 %conv7.i185, ptr %arrayidx8.i186, align 1, !tbaa !8
  %add.ptr93 = getelementptr inbounds i8, ptr %digest, i64 4, !BLADE-T !7
  %conv.i187 = trunc i32 %add87 to i8
  store i8 %conv.i187, ptr %add.ptr93, align 1, !tbaa !8
  %shr.i188 = lshr i32 %add87, 8
  %conv1.i189 = trunc i32 %shr.i188 to i8
  %arrayidx2.i190 = getelementptr inbounds i8, ptr %digest, i64 5, !BLADE-T !7
  store i8 %conv1.i189, ptr %arrayidx2.i190, align 1, !tbaa !8
  %shr3.i191 = lshr i32 %add87, 16
  %conv4.i192 = trunc i32 %shr3.i191 to i8
  %arrayidx5.i193 = getelementptr inbounds i8, ptr %digest, i64 6, !BLADE-T !7
  store i8 %conv4.i192, ptr %arrayidx5.i193, align 1, !tbaa !8
  %shr6.i194 = lshr i32 %add87, 24
  %conv7.i195 = trunc i32 %shr6.i194 to i8
  %arrayidx8.i196 = getelementptr inbounds i8, ptr %digest, i64 7, !BLADE-T !7
  store i8 %conv7.i195, ptr %arrayidx8.i196, align 1, !tbaa !8
  %add.ptr94 = getelementptr inbounds i8, ptr %digest, i64 8, !BLADE-T !7
  %conv.i197 = trunc i32 %add88 to i8
  store i8 %conv.i197, ptr %add.ptr94, align 1, !tbaa !8
  %shr.i198 = lshr i32 %add88, 8
  %conv1.i199 = trunc i32 %shr.i198 to i8
  %arrayidx2.i200 = getelementptr inbounds i8, ptr %digest, i64 9, !BLADE-T !7
  store i8 %conv1.i199, ptr %arrayidx2.i200, align 1, !tbaa !8
  %shr3.i201 = lshr i32 %add88, 16
  %conv4.i202 = trunc i32 %shr3.i201 to i8
  %arrayidx5.i203 = getelementptr inbounds i8, ptr %digest, i64 10, !BLADE-T !7
  store i8 %conv4.i202, ptr %arrayidx5.i203, align 1, !tbaa !8
  %shr6.i204 = lshr i32 %add88, 24
  %conv7.i205 = trunc i32 %shr6.i204 to i8
  %arrayidx8.i206 = getelementptr inbounds i8, ptr %digest, i64 11, !BLADE-T !7
  store i8 %conv7.i205, ptr %arrayidx8.i206, align 1, !tbaa !8
  %add.ptr95 = getelementptr inbounds i8, ptr %digest, i64 12, !BLADE-T !7
  %conv.i207 = trunc i32 %add89 to i8
  store i8 %conv.i207, ptr %add.ptr95, align 1, !tbaa !8
  %shr.i208 = lshr i32 %add89, 8
  %conv1.i209 = trunc i32 %shr.i208 to i8
  %arrayidx2.i210 = getelementptr inbounds i8, ptr %digest, i64 13, !BLADE-T !7
  store i8 %conv1.i209, ptr %arrayidx2.i210, align 1, !tbaa !8
  %shr3.i211 = lshr i32 %add89, 16
  %conv4.i212 = trunc i32 %shr3.i211 to i8
  %arrayidx5.i213 = getelementptr inbounds i8, ptr %digest, i64 14, !BLADE-T !7
  store i8 %conv4.i212, ptr %arrayidx5.i213, align 1, !tbaa !8
  %shr6.i214 = lshr i32 %add89, 24
  %conv7.i215 = trunc i32 %shr6.i214 to i8
  %arrayidx8.i216 = getelementptr inbounds i8, ptr %digest, i64 15, !BLADE-T !7
  store i8 %conv7.i215, ptr %arrayidx8.i216, align 1, !tbaa !8
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %w) #10, !BLADE-T !7
  ret void
}
...
for.body:                                         ; preds = %for.body, %entry
  ...
  br i1 %exitcond.not, label %for.body3.preheader, label %for.body, !llvm.loop !18

for.body3.preheader:                              ; preds = %for.body
  %0 = load i8, ptr %result, align 16, !tbaa !8
  ...
  %1 = load i8, ptr %arrayidx.1, align 1, !tbaa !8
  ...
  %2 = load i8, ptr %arrayidx.2, align 2, !tbaa !8
  ...
  %3 = load i8, ptr %arrayidx.3, align 1, !tbaa !8
  ...
  %4 = load i8, ptr %arrayidx.4, align 4, !tbaa !8
  ...
  %5 = load i8, ptr %arrayidx.5, align 1, !tbaa !8
  ...
  %6 = load i8, ptr %arrayidx.6, align 2, !tbaa !8
  ...
  %7 = load i8, ptr %arrayidx.7, align 1, !tbaa !8
  ...
  %8 = load i8, ptr %arrayidx.8, align 8, !tbaa !8
  ...
  %9 = load i8, ptr %arrayidx.9, align 1, !tbaa !8
  ...
  %10 = load i8, ptr %arrayidx.10, align 2, !tbaa !8
  ...
  %11 = load i8, ptr %arrayidx.11, align 1, !tbaa !8
  ...
  %12 = load i8, ptr %arrayidx.12, align 4, !tbaa !8
  ...
  %13 = load i8, ptr %arrayidx.13, align 1, !tbaa !8
  ...
  %14 = load i8, ptr %arrayidx.14, align 2, !tbaa !8
  ...
  %15 = load i8, ptr %arrayidx.15, align 1, !tbaa !8
