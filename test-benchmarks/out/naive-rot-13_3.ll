...
entry:
  %call = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %str) #9, !BLADE-T !7
...
for.body:                                         ; preds = %for.inc, %for.body.preheader
  ...
  %arrayidx = getelementptr inbounds i8, ptr %str, i64 %indvars.iv, !BLADE-T !7, !BLADE-S !8
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  store i8 %conv32, ptr %arrayidx, align 1, !tbaa !9
...
if.then40:                                        ; preds = %if.end
  ...
  store i8 %conv45, ptr %arrayidx, align 1, !tbaa !9
  br label %for.inc

for.inc:                                          ; preds = %if.then40, %if.end, %lor.lhs.false, %for.body
...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(53) %buf, ptr noundef nonnull align 16 dereferenceable(53) @__const.rot13_test.text, i64 53, i1 false) #8
...
if.end.i:                                         ; preds = %lor.lhs.false.i
  ...
  store i8 %conv32.i, ptr %arrayidx.i, align 1, !tbaa !9
...
if.then40.i:                                      ; preds = %if.end.i
  ...
  store i8 %conv45.i, ptr %arrayidx.i, align 1, !tbaa !9
  br label %for.inc.i

for.inc.i:                                        ; preds = %if.then40.i, %if.end.i, %lor.lhs.false.i, %for.body.i
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %rot13.exit, label %for.body.i, !llvm.loop !12
...
rot13.exit:                                       ; preds = %for.inc.i, %entry
  ...
  %call.i20 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %buf) #9
...
for.body.i29:                                     ; preds = %for.inc.i50, %for.body.preheader.i24
  ...
  %2 = load i8, ptr %arrayidx.i26, align 1, !tbaa !9
  %.fr.i27 = freeze i8 %2
...
if.end.i44:                                       ; preds = %lor.lhs.false.i33
  ...
  store i8 %conv32.i42, ptr %arrayidx.i26, align 1, !tbaa !9
...
if.then40.i47:                                    ; preds = %if.end.i44
  ...
  store i8 %conv45.i46, ptr %arrayidx.i26, align 1, !tbaa !9
...
for.inc.i50:                                      ; preds = %if.then40.i47, %if.end.i44, %lor.lhs.false.i33, %for.body.i29
  ...
  br i1 %exitcond.not.i49, label %rot13.exit51, label %for.body.i29, !llvm.loop !12
