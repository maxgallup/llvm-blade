...
iter.check:
  store <16 x i8> <i8 0, i8 1, i8 2, i8 3, i8 4, i8 5, i8 6, i8 7, i8 8, i8 9, i8 10, i8 11, i8 12, i8 13, i8 14, i8 15>, ptr %state, align 1, !tbaa !7
...
for.body4:                                        ; preds = %iter.check, %for.body4
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %for.body4 ], [ 0, %iter.check ]
  %j.041 = phi i8 [ %add11.narrow, %for.body4 ], [ 0, %iter.check ]
  %arrayidx6 = getelementptr inbounds i8, ptr %state, i64 %indvars.iv44
  %15 = load i8, ptr %arrayidx6, align 1, !tbaa !7
  %add = add i8 %15, %j.041
  %16 = trunc i64 %indvars.iv44 to i32
  %rem = srem i32 %16, %len
  %idxprom8 = zext i32 %rem to i64
  %arrayidx9 = getelementptr inbounds i8, ptr %key, i64 %idxprom8
  %17 = load i8, ptr %arrayidx9, align 1, !tbaa !7
  %add11.narrow = add i8 %add, %17
  %idxprom15 = zext i8 %add11.narrow to i64
  %arrayidx16 = getelementptr inbounds i8, ptr %state, i64 %idxprom15
  %18 = load i8, ptr %arrayidx16, align 1, !tbaa !7
  ...
  br i1 %exitcond46.not, label %for.end23, label %for.body4, !llvm.loop !10
...
for.body4.i:                                      ; preds = %iter.check, %for.body4.i
  ...
  br i1 %exitcond46.not.i, label %iter.check57, label %for.body4.i, !llvm.loop !10
...
for.body4.i.1:                                    ; preds = %iter.check57, %for.body4.i.1
  ...
  br i1 %exitcond46.not.i.1, label %arcfour_key_setup.exit.1, label %for.body4.i.1, !llvm.loop !10
...
vector.body88:                                    ; preds = %arcfour_key_setup.exit.1, %land.rhs.1
...
for.body4.i.2:                                    ; preds = %vector.body88, %for.body4.i.2
  ...
  br i1 %exitcond46.not.i.2, label %arcfour_key_setup.exit.2, label %for.body4.i.2, !llvm.loop !10
...
^1 = gv: (name: "arcfour_generate_stream", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 27, funcFlags: (readNone: 0, readOnly: 0, noRecurse: 1, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0)))) ; guid = 487110026370743853
^2 = gv: (name: ".str.1", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 6965315235255071444
^3 = gv: (name: "printf") ; guid = 7383291119112528047
^4 = gv: (name: "bcmp") ; guid = 8597674443648877653
^5 = gv: (name: ".str", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 10621076521968305264
^6 = gv: (name: "arcfour_key_setup", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 52, funcFlags: (readNone: 0, readOnly: 0, noRecurse: 1, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0)))) ; guid = 14585561509928904485
^7 = gv: (name: "__const.rc4_test.stream", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 15535096936195698286
^8 = gv: (name: "rc4_test", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 501, funcFlags: (readNone: 1, readOnly: 0, noRecurse: 0, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0), calls: ((callee: ^4, relbf: 353)), refs: (^9, ^7)))) ; guid = 15784378257491535473
^9 = gv: (name: "__const.rc4_test.key", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 15803692615287921352
^10 = gv: (name: "main", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 10, funcFlags: (readNone: 0, readOnly: 0, noRecurse: 0, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0), calls: ((callee: ^8, relbf: 256), (callee: ^3, relbf: 8160)), refs: (^11, ^2, ^5)))) ; guid = 15822663052811949562
^11 = gv: (name: ".str.2", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 16313866359719108267
^12 = flags: 8
^13 = blockcount: 18
