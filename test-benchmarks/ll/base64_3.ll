...
if.then26:                                        ; preds = %if.else18
  %add29 = add nuw nsw i8 %ch, 4
  br label %if.end44

if.else31:                                        ; preds = %if.else18
  %cmp33 = icmp eq i8 %ch, 43
  br i1 %cmp33, label %if.end44, label %if.else36

if.else36:                                        ; preds = %if.else31
  %cmp38 = icmp eq i8 %ch, 47
  %spec.store.select = select i1 %cmp38, i8 63, i8 %ch
  br label %if.end44

if.end44:                                         ; preds = %entry, %if.else31, %if.then14, %if.else36, %if.then26
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %arrayidx = getelementptr inbounds i8, ptr %in, i64 %idx.0184
  %0 = load i8, ptr %arrayidx, align 1, !tbaa !7
  %1 = lshr i8 %0, 2
  %idxprom = zext i8 %1 to i64
  %arrayidx9 = getelementptr inbounds [65 x i8], ptr @charset, i64 0, i64 %idxprom
  %2 = load i8, ptr %arrayidx9, align 1, !tbaa !7
  %arrayidx10 = getelementptr inbounds i8, ptr %out, i64 %idx2.1183
  store i8 %2, ptr %arrayidx10, align 1, !tbaa !7
  %3 = load i8, ptr %arrayidx, align 1, !tbaa !7
  %4 = shl i8 %3, 4
  %5 = and i8 %4, 48
  %add13 = add nuw i64 %idx.0184, 1
  %arrayidx14 = getelementptr inbounds i8, ptr %in, i64 %add13
  %6 = load i8, ptr %arrayidx14, align 1, !tbaa !7
  %7 = lshr i8 %6, 4
  %or180 = or i8 %5, %7
  %idxprom17 = zext i8 %or180 to i64
  %arrayidx18 = getelementptr inbounds [65 x i8], ptr @charset, i64 0, i64 %idxprom17
  %8 = load i8, ptr %arrayidx18, align 1, !tbaa !7
  %add19 = add i64 %idx2.1183, 1
  %arrayidx20 = getelementptr inbounds i8, ptr %out, i64 %add19
  store i8 %8, ptr %arrayidx20, align 1, !tbaa !7
  %9 = load i8, ptr %arrayidx14, align 1, !tbaa !7
  %10 = shl i8 %9, 2
  %11 = and i8 %10, 60
  %add26 = add i64 %idx.0184, 2
  %arrayidx27 = getelementptr inbounds i8, ptr %in, i64 %add26
  %12 = load i8, ptr %arrayidx27, align 1, !tbaa !7
  %13 = lshr i8 %12, 6
  %or30181 = or i8 %11, %13
  %idxprom31 = zext i8 %or30181 to i64
  %arrayidx32 = getelementptr inbounds [65 x i8], ptr @charset, i64 0, i64 %idxprom31
  %14 = load i8, ptr %arrayidx32, align 1, !tbaa !7
  %add33 = add i64 %idx2.1183, 2
  %arrayidx34 = getelementptr inbounds i8, ptr %out, i64 %add33
  store i8 %14, ptr %arrayidx34, align 1, !tbaa !7
  %15 = load i8, ptr %arrayidx27, align 1, !tbaa !7
  %16 = and i8 %15, 63
  %idxprom39 = zext i8 %16 to i64
  %arrayidx40 = getelementptr inbounds [65 x i8], ptr @charset, i64 0, i64 %idxprom39
  %17 = load i8, ptr %arrayidx40, align 1, !tbaa !7
  %add41 = add i64 %idx2.1183, 3
  %arrayidx42 = getelementptr inbounds i8, ptr %out, i64 %add41
  store i8 %17, ptr %arrayidx42, align 1, !tbaa !7
...
if.then48:                                        ; preds = %for.body
  %arrayidx50 = getelementptr inbounds i8, ptr %out, i64 %sub
  store i8 10, ptr %arrayidx50, align 1, !tbaa !7
...
if.then57:                                        ; preds = %for.end
  %arrayidx58 = getelementptr inbounds i8, ptr %in, i64 %idx.0.lcssa
  %18 = load i8, ptr %arrayidx58, align 1, !tbaa !7
  %19 = lshr i8 %18, 2
  %idxprom61 = zext i8 %19 to i64
  %arrayidx62 = getelementptr inbounds [65 x i8], ptr @charset, i64 0, i64 %idxprom61
  %20 = load i8, ptr %arrayidx62, align 1, !tbaa !7
  %arrayidx63 = getelementptr inbounds i8, ptr %out, i64 %idx2.1.lcssa
  store i8 %20, ptr %arrayidx63, align 1, !tbaa !7
  %21 = load i8, ptr %arrayidx58, align 1, !tbaa !7
  %22 = shl i8 %21, 4
  %23 = and i8 %22, 48
  %idxprom68 = zext i8 %23 to i64
  %arrayidx69 = getelementptr inbounds [65 x i8], ptr @charset, i64 0, i64 %idxprom68
  %24 = load i8, ptr %arrayidx69, align 16, !tbaa !7
  %add70 = add i64 %idx2.1.lcssa, 1
  %arrayidx71 = getelementptr inbounds i8, ptr %out, i64 %add70
  store i8 %24, ptr %arrayidx71, align 1, !tbaa !7
  %add72 = add i64 %idx2.1.lcssa, 2
  %arrayidx73 = getelementptr inbounds i8, ptr %out, i64 %add72
  store i8 61, ptr %arrayidx73, align 1, !tbaa !7
  %add74 = add i64 %idx2.1.lcssa, 3
  %arrayidx75 = getelementptr inbounds i8, ptr %out, i64 %add74
  store i8 61, ptr %arrayidx75, align 1, !tbaa !7
  %add76 = add i64 %idx2.1.lcssa, 4
  br label %if.end114

if.then80:                                        ; preds = %for.end
  %arrayidx81 = getelementptr inbounds i8, ptr %in, i64 %idx.0.lcssa
  %25 = load i8, ptr %arrayidx81, align 1, !tbaa !7
  %26 = lshr i8 %25, 2
  %idxprom84 = zext i8 %26 to i64
  %arrayidx85 = getelementptr inbounds [65 x i8], ptr @charset, i64 0, i64 %idxprom84
  %27 = load i8, ptr %arrayidx85, align 1, !tbaa !7
  %arrayidx86 = getelementptr inbounds i8, ptr %out, i64 %idx2.1.lcssa
  store i8 %27, ptr %arrayidx86, align 1, !tbaa !7
  %28 = load i8, ptr %arrayidx81, align 1, !tbaa !7
  %29 = shl i8 %28, 4
  %30 = and i8 %29, 48
  %add91 = add i64 %idx.0.lcssa, 1
  %arrayidx92 = getelementptr inbounds i8, ptr %in, i64 %add91
  %31 = load i8, ptr %arrayidx92, align 1, !tbaa !7
  %32 = lshr i8 %31, 4
  %or95179 = or i8 %30, %32
  %idxprom96 = zext i8 %or95179 to i64
  %arrayidx97 = getelementptr inbounds [65 x i8], ptr @charset, i64 0, i64 %idxprom96
  %33 = load i8, ptr %arrayidx97, align 1, !tbaa !7
  %add98 = add i64 %idx2.1.lcssa, 1
  %arrayidx99 = getelementptr inbounds i8, ptr %out, i64 %add98
  store i8 %33, ptr %arrayidx99, align 1, !tbaa !7
  %34 = load i8, ptr %arrayidx92, align 1, !tbaa !7
  %35 = shl i8 %34, 2
  %36 = and i8 %35, 60
  %idxprom105 = zext i8 %36 to i64
  %arrayidx106 = getelementptr inbounds [65 x i8], ptr @charset, i64 0, i64 %idxprom105
  %37 = load i8, ptr %arrayidx106, align 4, !tbaa !7
  %add107 = add i64 %idx2.1.lcssa, 2
  %arrayidx108 = getelementptr inbounds i8, ptr %out, i64 %add107
  store i8 %37, ptr %arrayidx108, align 1, !tbaa !7
  %add109 = add i64 %idx2.1.lcssa, 3
  %arrayidx110 = getelementptr inbounds i8, ptr %out, i64 %add109
  store i8 61, ptr %arrayidx110, align 1, !tbaa !7
  %add111 = add i64 %idx2.1.lcssa, 4
  br label %if.end114

if.end114:                                        ; preds = %for.end, %if.then57, %if.then80, %if.then, %if.then3
...
land.lhs.true:                                    ; preds = %if.then12
  ...
  %2 = load i8, ptr %arrayidx15, align 1, !tbaa !7
...
for.body:                                         ; preds = %if.else33, %revchar.exit276
  ...
  %3 = load i8, ptr %arrayidx37, align 1, !tbaa !7
  ...
  %4 = load i8, ptr %arrayidx44, align 1, !tbaa !7
  %5 = add i8 %4, -65
...
revchar.exit:                                     ; preds = %for.body, %if.then14.i, %if.then26.i, %if.else31.i, %if.else36.i
  ...
  %8 = load i8, ptr %arrayidx47, align 1, !tbaa !7
  %9 = add i8 %8, -65
...
revchar.exit212:                                  ; preds = %revchar.exit, %if.then14.i201, %if.then26.i205, %if.else31.i207, %if.else36.i210
  ...
  store i8 %or, ptr %arrayidx51, align 1, !tbaa !7
  %14 = load i8, ptr %arrayidx47, align 1, !tbaa !7
  %15 = add i8 %14, -65
...
revchar.exit228:                                  ; preds = %revchar.exit212, %if.then14.i217, %if.then26.i221, %if.else31.i223, %if.else36.i226
...
revchar.exit244:                                  ; preds = %revchar.exit228, %if.then14.i233, %if.then26.i237, %if.else31.i239, %if.else36.i242
  ...
  store i8 %or62, ptr %arrayidx65, align 1, !tbaa !7
  %23 = load i8, ptr %arrayidx58, align 1, !tbaa !7
  %24 = add i8 %23, -65
...
revchar.exit260:                                  ; preds = %revchar.exit244, %if.then14.i249, %if.then26.i253, %if.else31.i255, %if.else36.i258
  ...
  %27 = load i8, ptr %arrayidx72, align 1, !tbaa !7
  %28 = add i8 %27, -65
...
revchar.exit276:                                  ; preds = %revchar.exit260, %if.then14.i265, %if.then26.i269, %if.else31.i271, %if.else36.i274
  ...
  store i8 %or75, ptr %arrayidx78, align 1, !tbaa !7
...
if.then83:                                        ; preds = %for.end
  ...
  %31 = load i8, ptr %arrayidx84, align 1, !tbaa !7
  %32 = add i8 %31, -65
...
revchar.exit292:                                  ; preds = %if.then83, %if.then14.i281, %if.then26.i285, %if.else31.i287, %if.else36.i290
  ...
  %35 = load i8, ptr %arrayidx89, align 1, !tbaa !7
  %36 = add i8 %35, -65
...
revchar.exit308:                                  ; preds = %revchar.exit292, %if.then14.i297, %if.then26.i301, %if.else31.i303, %if.else36.i306
...
revchar.exit324:                                  ; preds = %if.then101, %if.then14.i313, %if.then26.i317, %if.else31.i319, %if.else36.i322
  ...
  %45 = load i8, ptr %arrayidx107, align 1, !tbaa !7
  %46 = add i8 %45, -65
...
revchar.exit340:                                  ; preds = %revchar.exit324, %if.then14.i329, %if.then26.i333, %if.else31.i335, %if.else36.i338
  ...
  store i8 %or112, ptr %arrayidx114, align 1, !tbaa !7
  %51 = load i8, ptr %arrayidx107, align 1, !tbaa !7
  %52 = add i8 %51, -65
...
revchar.exit356:                                  ; preds = %revchar.exit340, %if.then14.i345, %if.then26.i349, %if.else31.i351, %if.else36.i354
  ...
  %55 = load i8, ptr %arrayidx121, align 1, !tbaa !7
  %56 = add i8 %55, -65
...
revchar.exit372:                                  ; preds = %revchar.exit356, %if.then14.i361, %if.then26.i365, %if.else31.i367, %if.else36.i370
  ...
  store i8 %or125, ptr %arrayidx128, align 1, !tbaa !7
  %add129 = add i64 %idx.0.lcssa, 2
  br label %if.end132

if.end132:                                        ; preds = %for.end, %if.end22, %revchar.exit308, %revchar.exit372, %if.then27, %if.then30
...
land.end72.2:                                     ; preds = %land.end30.2.thread, %land.rhs64.2, %land.end30.2
...
^1 = gv: (name: ".str.1", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 660991551780095458
^2 = gv: (name: "charset", summaries: (variable: (module: ^0, flags: (linkage: internal, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 5236200853038022190
^3 = gv: (name: ".str", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 7172944434847743335
^4 = gv: (name: "printf") ; guid = 7383291119112528047
^5 = gv: (name: "base64_encode", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 147, funcFlags: (readNone: 0, readOnly: 0, noRecurse: 1, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0), refs: (^2)))) ; guid = 8307576766667670215
^6 = gv: (name: "bcmp") ; guid = 8597674443648877653
^7 = gv: (name: "__const.base64_test.code", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 9406361286808729401
^8 = gv: (name: "base64_test", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 55, funcFlags: (readNone: 1, readOnly: 0, noRecurse: 0, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0), calls: ((callee: ^5, relbf: 764), (callee: ^10, relbf: 762), (callee: ^6, relbf: 247)), refs: (^9, ^7)))) ; guid = 10807282106043921454
^9 = gv: (name: "__const.base64_test.text", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 11929404029917866275
^10 = gv: (name: "base64_decode", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 344, funcFlags: (readNone: 0, readOnly: 0, noRecurse: 1, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0)))) ; guid = 14120925273534286724
^11 = gv: (name: "revchar", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 20, funcFlags: (readNone: 1, readOnly: 0, noRecurse: 1, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0)))) ; guid = 14902904487891056178
^12 = gv: (name: "main", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 10, funcFlags: (readNone: 0, readOnly: 0, noRecurse: 0, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0), calls: ((callee: ^8, relbf: 256), (callee: ^4, relbf: 8160)), refs: (^13, ^1, ^3)))) ; guid = 15822663052811949562
^13 = gv: (name: ".str.2", summaries: (variable: (module: ^0, flags: (linkage: private, visibility: default, notEligibleToImport: 1, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 0, constant: 1)))) ; guid = 18422430442611129596
^14 = flags: 8
^15 = blockcount: 133
